...
#include "afscript.h"
                             ...
                             FT_Bool         default_script )
  {
    ...
    for ( idx = HB_SET_VALUE_INVALID; hb(set_next)( gsub_glyphs, &idx ); )
    {
      ...
      /* glyph indices returned by `hb(ot_layout_lookup_collect_glyphs)' */
...
#include "afcover.h"
                          ...
                          FT_Bool         default_script )
  {
    ...
    if ( ft_hb_enabled( globals ))
      return af_shaper_get_coverage_hb( globals, style_class, gstyles, default_script );
    else
#endif
      return af_shaper_get_coverage_nohb( globals, style_class, gstyles, default_script );
  }
