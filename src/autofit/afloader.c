...
#include "afpic.h"
  ...
  /* Do the main work of `af_loader_load_glyph'.  Note that    */
  /* we never have to deal with composite glyphs as those get  */
  /* loaded into FORMAT_OUTLINE by the recursed FT_Load_Glyph. */
  /* In the rare cases that NO_RECURSE load flags is set, it   */
  /* implies NO_SCALE and as such autohinter is never called.  */
